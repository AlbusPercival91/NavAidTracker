...
public class PdfService {
    ...
    private String extractChartNumber(String text) {
        Pattern pattern = Pattern.compile("Chart\\s+(\\d+\\s*\\(.*?\\)|\\d+)"); // Matches "Chart 1429 (INT 1403)" or "Chart 1429"
    ...
    // Helper method to extract Action Info
    ...
    // Helper method to extract Lat/Long
